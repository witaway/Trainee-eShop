...
class ProductController {
    ...
    static async create(req, res) {
        ...
        res.status(200).json(ResponseFormat.success(
            200, 'Product is created successfully', result
        )); 
    }
    ...
    static async getByID(req, res) {
        ...
        res.status(200).json(ResponseFormat.success(
            200, 'Product is got successfully', result
        )); 
    }
    ...
    static async getList(req, res) {
        ...
        res.status(200).json(ResponseFormat.success(
            200, 'Products are got successfully', result
        )); 
    }
    ...
    static async editByID(req, res) {
        ...
        res.status(200).json(ResponseFormat.success(
            200, 'Products is edited successfully', result
        )); 
    }
