...
class RoleController {
    ...
    static async createRole(req, res) {
        ...
        res.status(200).json(ResponseFormat.success(
            200, 'Role is created successfully', role
        )); 
    }
    ...
    static async getListOfRoles(req, res) {
        ...
        res.status(200).json(ResponseFormat.success(
            200, 'List of roles is got successfully', rolesList
        )); 
    }
    ...
    static async getRoleByID(req, res) {
        ...
        res.status(200).json(ResponseFormat.success(
            200, 'Role is got successfully', role
        ));
    }
    ...
    static async editRoleByID(req, res) {
        ...
        res.status(200).json(ResponseFormat.success(
            200, 'Role is edited successfully', updatedRole
        ));
    }
    ...
    static async deleteRoleByID(req, res) {
        ...
        res.status(200).json(ResponseFormat.success(
            200, 'Role is deleted successfully', {}
        ));
    }
