...
class DeletionRequestController {
    ...
    static async getRequestsList(req, res) {
        ...
        res.status(200).json(ResponseFormat.success(
            200, 'Deletion requests list got successfully', result
        ));
    }
    ...
    static async getRequestByID(req, res) {
        ...
        res.status(200).json(ResponseFormat.success(
            200, 'Deletion request is got successfully', result
        ));
    }
    ...
    static async acceptRequestByID(req, res) {
        ...
        res.status(200).json(ResponseFormat.success(
            200, 'Deletion request accepted successfully', result
        ));
    }
    ...
    static async deleteRequestByID(req, res) {
        ...
        res.status(200).json(ResponseFormat.success(
            200, 'Deletion request deleted successfully', {}
        ));    
    }
}
